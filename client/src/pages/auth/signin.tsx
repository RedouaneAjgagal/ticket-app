...
const signin = () => {
    ...
    return (
        <section>
            <h1 className="text-center text-5xl font-semibold text-stone-800">Sign In</h1>
            <form onSubmit={signInHandler} className="flex flex-col gap-4">
                ...
                <div>
                    <button disabled={isLoading} type="submit" className="py-2 px-4 rounded bg-amber-600 font-medium text-white">Sign In</button>
                </div>
                {errors.length
